...
export default function Footer() {
  return (
    <Container
      ...
      <FadeInUp as="section" className="px-4 md:bg-primary-light rounded-full p-4">
        <Container className="sm:px-0 lg:px-0">
          <div className="flex flex-col gap-4 md:flex-row justify-between items-center">
            ...
            <div className="flex gap-2">
              <Link href="/" className="bg-primary rounded-full p-2 hover:scale-110 transition-transform">
